...
?>
    ...
    <body>
        <div class="container">
            ...
            <div class="row cartas adicionar-cartas">
                <h2 class="titulo">Adicionar cartas</h2>
                <div class="col">
                    <div class="area-titulo-tabela">
                        <h3>Cartas Brancas <span class="qtd-brancas badge bg-secondary"><span class="qtd">0</span></span>
                        </h3>
                    ...
                    <div class="area-tabela cartas-brancas">
                        <table class="table table-hover">
                            ...
                            <tbody class="corpo-tabela-brancas">
                                <tr class="linha-nova-carta" tipo="b">
                                    ...
                                    <th scope="col" class="col-categoria">
                                        <select class="form-control select-categorias"></select>
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                        <div class="d-grid">
                            <button type="button" class="btn btn-primary mais-carta" tipo="brancas">+</button>
                        </div>
                    </div>
                </div>
                <div class="col">
                    ...
                    <div class="area-tabela cartas-pretas">
                        <table class="table table-dark table-hover">
                            ...
                            <tbody class="corpo-tabela-pretas">
                                <tr class="linha-nova-carta" tipo="p">
                                    <th scope="col" class="col-texto">
                                        <input class="form-control campo-nova-carta" type="text" name="campo-nova-carta" placeholder="Digite aqui..."></input>
                                    </th>
                                    <th scope="col" class="col-categoria">
                        ...
                        <div class="d-grid">
                            <button type="button" class="btn btn-primary mais-carta" tipo="pretas">+</button>
                        </div>
                    </div>
                </div>
                <div class="d-grid">
                    <button type="button" id="btn-salva-novas-cartas" class="btn btn-primary mt-3">Salvar cartas</button>
                </div>
            </div>
            <div class="row mensagens">
                <h2 class="titulo">Mensagens <span class="qtd-mensagens badge bg-secondary"><span class="qtd">0</span></span>
                </h2>
